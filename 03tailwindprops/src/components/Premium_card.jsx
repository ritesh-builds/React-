...
function Premium_card(props) {
  ...
  return (
    <div>
      <div
        className="m-10 p-1 shadow-2xl bg-white border border-zinc-800 hover:border-white rounded-2xl transition-all duration-300 hover:scale-105 cursor-pointer max-w-md mx-auto"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-6 h-6 bg-gray-400 rounded-full border-2 border-black"></div>
                  <div className="w-6 h-6 bg-gray-600 rounded-full border-2 border-black"></div>
                </div>
              ...
              <button
                ...
                className="px-4 py-2 bg-white hover:bg-gray-200 text-black text-sm rounded-lg transition-all duration-200 hover:scale-105"
              >
                Get Started ({count})
              </button>
            </div>
